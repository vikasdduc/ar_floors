...
class FirebaseManager {
  ...
  Future<String> getImageUrl(String imagePathInFirestore) async {
    Reference reference = FirebaseStorage.instance.ref().child(imagePathInFirestore);
