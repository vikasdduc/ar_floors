...
class _AssetsObjectState extends State<AssetsObject> {
  ...
  List<ArCorePlane> arPlane = [];
  List<ArCorePlaneType> planeType = [];
  List<ArCoreHitTestResult> arCoreHitTestResul = [];
  List<ArCoreAugmentedImage> arCoreAugmentedImag = [];
  List<ArCoreReferenceNode> arCoreReferenceNod = [];
  List<ArCoreAugmentedImageTrackingHandler> arCoreAugmented = [];
  ...
  void _onArCoreViewCreated(ArCoreController controller) {
    ...
    arCoreController?.onPlaneDetected = onPlaneDetected;
  }
  ...
  void _addToucano(ArCoreHitTestResult plane) {
    if (objectSelected != null) {
      ...
      final toucanoNode = ArCoreReferenceNode(
          name: objectSelected,
          objectUrl:"https://github.com/KhronosGroup/glTF-Sample-Models/raw/master/2.0/Box/glTF/Box.gltf",
          //object3DFileName: objectSelected,
          position: plane.pose.translation,
          rotation: plane.pose.rotation,
          //scale: plane.translation.xyz
      );
